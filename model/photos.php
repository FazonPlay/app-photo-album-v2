...
function addPhoto(PDO $pdo, string $title, string $filePath, int $userId, string $description = null, int $albumId = 1): bool|string {
    $query = "INSERT INTO photos (title, file_path, user_id, description, upload_date, album_id) VALUES (:title, :file_path, :user_id, :description, NOW(), :album_id)";
    $prep = $pdo->prepare($query);
